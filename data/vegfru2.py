...
class Vegfru(Dataset):
    ...
    @staticmethod
    def init(root):
        # This file combine train and val as a new train dataset.
        ...
        for i in range(len(images_val)):
            train_images.append(images_val['filepath'][i])
        ...
        k = len(images_train)
        for i in range(len(images_val)):
            label_list_train.append(int(images_val['target'][i]) + 1)
            img_id_train.append(k + i + 1)
...
"""
veg200_images/houttuynia_cordata/v_08_18_0350.jpg
